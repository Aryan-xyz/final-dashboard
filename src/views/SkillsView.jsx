      ...
      <div className="cell-page">
        ...
        <div className="cell-hero">
          ...
          <p className="cell-hero-sub">
            Complete NCERT Chapter 19 sub-topics, interactive lesson modules,
        ...
        >
          ...
          >
            {NCERT_SKILLS_SECTIONS.map((sec, idx) => {
              ...
              const icon =
                SKILL_ICONS[idx % SKILL_ICONS.length];
